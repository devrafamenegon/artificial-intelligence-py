...
# ABERTA SE O SENSOR DE PRESSÃO OPERACIONAL ( ABERTA SE O SENSOR DE PRESSÃO OPERACIONAL (PressaoOperacional ) E O
# SENSOR DE TEMPERATURA ( SENSOR DE TEMPERATURA (Toperacional) FOREM ATIVADOS
...
entrypoints = [
    ...
    [1, 1, 1, 1, 1, 0, 0, 0],  # ON - N1, N2, N3, TMAX ativados
    [1, 1, 1, 1, 0, 1, 1, 1],  # ON - N1, N2, N3, PMAX, POper, TOper ativados
    [1, 1, 1, 1, 1, 0, 1, 1],  # ON - N1, N2, N3, TMAX, POper, TOper ativados
    ...
    [0, 1, 1, 1, 1, 0, 0, 0],  # OFF - N1, N2, N3, TMAX ativados
    [0, 1, 1, 1, 0, 1, 1, 1],  # OFF - N1, N2, N3, PMAX, POper, TOper ativados
    [0, 1, 1, 1, 1, 0, 1, 1],  # OFF - N1, N2, N3, TMAX, POper, TOper ativados
]

# SAÍDAS
#   ON/OFF  VALVULACHAMA  ENTRADAAGUA  VALVULAGAS  SAIDAVAPOR  SAIDAAGUA
expectedReturns = [
    [0, 0, 0, 0, 1],  # Desligado
    [1, 0, 0, 0, 1],  # Válvula de entrada de água aberta
    [1, 1, 0, 0, 0],  # Válvula de entrada de água fechada, válvula de gás fechada
    [1, 1, 1, 0, 0],  # Válvula de entrada de água fechada, válvula de gás aberta
...
while True:
    ...
    PressaoOperacional = input(
        "Sensor de pressão operacional ativado? [0 - Não, 1 - Sim]: "
    )
    TOperacional = int(
    ...
    predicted_output = caldeira.predict(
        [[N1, N2, N3, TMAX, PMAX, PressaoOperacional, TOperacional, ON]]
    )
